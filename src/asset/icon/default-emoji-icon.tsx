export default function DefaultEmojiIcon() {
  return (
    <svg
      width="22"
      height="22"
    ...
    >
      ...
      <path
        ...
        fill="black"
      />
      <path d="M5.48616 2.89961H4.2608V4.14586H5.48616V2.89961Z" fill="black" />
      <path
      ...
      <path
        ...
        fill="black"
      />
      <path d="M20.19 5.39211H18.9647V6.63836H20.19V5.39211Z" fill="black" />
      <path d="M20.19 6.63836H18.9647V7.88461H20.19V6.63836Z" fill="black" />
      <path
      ...
      <path
        ...
        fill="black"
      />
      <path d="M21.4154 7.88461H20.19V9.13086H21.4154V7.88461Z" fill="black" />
      <path d="M21.4154 9.13086H20.19V10.3771H21.4154V9.13086Z" fill="black" />
      <path d="M21.4154 10.3771H20.19V11.6234H21.4154V10.3771Z" fill="black" />
      <path d="M21.4154 11.6234H20.19V12.8696H21.4154V11.6234Z" fill="black" />
      <path d="M21.4154 12.8696H20.19V14.1159H21.4154V12.8696Z" fill="black" />
      <path
      ...
      <path
        ...
        fill="black"
      />
      <path d="M7.9364 15.3616V16.6079H9.16176V15.3616H7.9364Z" fill="black" />
      <path
      ...
      <path
        ...
        fill="black"
      />
      <path d="M20.19 14.1154H18.9647V15.3616H20.19V14.1154Z" fill="black" />
      <path d="M20.19 15.3616H18.9647V16.6079H20.19V15.3616Z" fill="black" />
      <path
        d="M4.26082 16.6079H3.03546V17.8541H4.26082V16.6079Z"
        fill="black"
      />
      <path d="M5.48616 17.8541H4.2608V19.1004H5.48616V17.8541Z" fill="black" />
      <path d="M6.7115 12.8696H5.48615V14.1159H6.7115V12.8696Z" fill="black" />
      <path
      ...
      <path
        ...
        fill="black"
      />
      <path d="M6.7115 19.1004H5.48615V20.3466H6.7115V19.1004Z" fill="black" />
      <path
      ...
      <path
        ...
        fill="black"
      />
      <path d="M6.7115 1.65337H5.48615V2.89962H6.7115V1.65337Z" fill="black" />
      <path
